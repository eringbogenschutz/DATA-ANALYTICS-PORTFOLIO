# HW2: Lyman Break Galaxy Spectra Analysis
...
- `hw2.R` — R script implementing the search  
- `hw2.csv` — output of the search (distances and shifts)  
- `hw2.Rmd` — R Markdown source for the report  
- `hw2.pdf` — compiled report with figures (click to view!)
