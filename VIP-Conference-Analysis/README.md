...
All analysis was preformed using **SQL**, demonstrating the use of: 
- INNER JOIN
- LEFT JOIN
- SELF JOIN
- Multi-table joins
...
Most VIPs are assigned to panels, with some workshops and keynote speaker. Several VIPs have no assigned event, indicating incomplete scheduling. 

**Query 2: Hotel Reservations & RSVPS**

**Question:** Whcih VIPS have RSVP'd for welcome and dinner events? 
...
- Complet joins inclusing self-joins
- Translating operational questions into SQL queries
- Data validation and gap identification
- Clean query structuring

**Conclusion**
This project demonstrates how SQL can be used to manage and analyze real-worls event logistics. The analysis provides actionable insights for conference planners by identifying participation gaps, feedback relationships, and hotel demand patterns. 

The queries are structured to relect real analyst workflows and business-driven questioning. 
